...
class ChoisirunitinerairePage extends StatelessWidget {
  UserClass? user;
  ChoisirunitinerairePage({Key? key, required this.user}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            'Choisir un itinéraire personnalisable',
            style: TextStyle(
                fontFamily: 'Recoleta',
                fontSize:
          ...
          children: [
            ...
            Container(
                width: const AdaptiveScreenSize()
                    .getadaptiveScreenSizeWidth(context, 335),
                height: const AdaptiveScreenSize()
                    .getadaptiveScreenSizeWidth(context, 530),
                child: ListView(
